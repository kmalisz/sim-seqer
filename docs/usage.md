...
```bash
nextflow pull nf-core/simseqer
```
...
First, go to the [nf-core/simseqer releases page](https://github.com/nf-core/simseqer/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
